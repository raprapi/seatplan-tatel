    ...
    <div id="templatemo_content_inner_wrapper">
    	...
    	<div id="tempatemo_content">
            ...
            <?php if(isset($_GET['action'])){
                if($_GET['action'] == 'student')include_once('studViewRec.php');
                else if($_GET['action'] == 'prof') include_once('studContent.php');
            }
            else include_once('studContent.php');
            ?>
            <?php include_once('studRight.php'); ?>
